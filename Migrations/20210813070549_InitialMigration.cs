        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    how_many_rounds = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_double_league_teams_leagues_league_id",
                        column: x => x.league_id,
                        principalTable: "leagues",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_double_league_teams_organisations_organisation_id",
                        column: x => x.organisation_id,
                        principalTable: "organisations",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    scorer_score = table.Column<int>(type: "integer", nullable: false),
                    opponent_score = table.Column<int>(type: "integer", nullable: false),
                    winner_goal = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_single_league_goals", x => x.id);
                    table.ForeignKey(
                        name: "fk_single_league_goals_single_league_matches_match_id",
                        column: x => x.match_id,
                        principalTable: "single_league_matches",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_single_league_goals_users_opponent_id",
                        column: x => x.opponent_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_single_league_goals_users_scored_by_user_id",
                        column: x => x.scored_by_user_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    opponent_team_score = table.Column<int>(type: "integer", nullable: false),
                    winner_goal = table.Column<bool>(type: "boolean", nullable: false),
                    user_scorer_id = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_double_league_goals_users_user_scorer_id",
                        column: x => x.user_scorer_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_double_league_goals_user_scorer_id",
                table: "double_league_goals",
                column: "user_scorer_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_double_league_teams_league_id",
                table: "double_league_teams",
                column: "league_id");

            migrationBuilder.CreateIndex(
                name: "ix_double_league_teams_organisation_id",
                table: "double_league_teams",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_single_league_goals_match_id",
                table: "single_league_goals",
                column: "match_id");

            migrationBuilder.CreateIndex(
                name: "ix_single_league_goals_opponent_id",
                table: "single_league_goals",
                column: "opponent_id");

            migrationBuilder.CreateIndex(
                name: "ix_single_league_goals_scored_by_user_id",
                table: "single_league_goals",
                column: "scored_by_user_id");
